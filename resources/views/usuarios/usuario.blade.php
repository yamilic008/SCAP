...
@section('content')
   <div class="box">
            <div class="box-header">
              ...
              <a href="{{ route('usuario.create') }}" class="btn btn-success pull-right">Crear Usuario</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tr>
                      ...
                      <td>
                        <a href="#" class="btn btn-xs btn-default"><i class="fa fa-eye"></i></a>
                          <a href="{{route ('usuario.edit',$users->id)}}" class="btn btn-xs btn-info"><i class="fa fa-pencil"></i></a>
                          <form method='POST' 
                                action="{{route('usuario.destroy',$users['id'])}}"
