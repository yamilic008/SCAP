    ...
    <div class="col-md-6">
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Crear Actividad Academica</h3>
            </div>

            <form class="form-horizontal" method="POST" action="{{ route('actacad.store') }}" id="form">
                {{ csrf_field() }}
                <div class="box-body">
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="name" type="hidden" name="total" value="0.00" >
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                         <select class="form-control" name="ccostos"  required autofocus>
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                         <select class="form-control" name="prioridad" id="prioridad" required autofocus>
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                         <select class="form-control" name="linea" id="linea" required autofocus>
                              <option  value="">Selecciona una linea de accion</option>
                        </select> 
                    </div>
                </div>
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                         <select class="form-control" name="gestion" id="gestion" required autofocus>
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}" >
                    ...
                    <div class="col-md-6">
                         <select class="form-control" name="area" id="area" required autofocus>
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                         <textarea class="form-control" rows="4" cols="50" name="descripcion" form="form" required autofocus placeholder="Introduce la descripcion aqui......"></textarea>
                    </div>
                </div>
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    <label for="descripcion" class="col-md-4 control-label">Objetivo</label>
                    <div class="col-md-6">
                         <textarea class="form-control" rows="4" cols="50" name="observacion" form="form" required autofocus placeholder="Introduce la observacion aqui......"></textarea>
                    </div>
                </div>
<!-- ---------------------------------------------------------------- -->
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                          ...
                          <span id="two-inputs"><input id="date-range200" size="20" value="" name="fechainicio" required autofocus placeholder="Fecha inicio"> a <input id="date-range201" size="20" value="" name="fechafin" required autofocus placeholder="Fecha Fin"></span>
                        </div>
                    </div>
                </div>
