...
@section('content')
   <div class="box">
            <div class="box-header">
              ...
              <a href="{{ route('pdf') }}" class="btn btn-info pull-right" target="_blank">Reporte</a>
              <a href="{{ route('seccion.create') }}" class="btn btn-success pull-right">Nueva Seccion</a>
                  ...
                  <tr>
                      ...
                      <td>
                       <!--  <a href="#" class="btn btn-xs btn-default"><i class="fa fa-eye"></i></a> -->
                          <a href="{{route ('seccion.edit',$dato->id)}}" class="btn btn-xs btn-info"><i class="fa fa-pencil"></i></a>
                          <form method='POST' 
                                action="{{route('seccion.destroy',$dato['id'])}}"
