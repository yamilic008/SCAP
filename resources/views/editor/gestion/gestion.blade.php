...
<h1>
        Gestion/Dirección
        <small>Gestion/Dirección</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Gestion/Direccion</li>
      </ol>
@endsection
...
@section('content')
   <div class="box">
            <div class="box-header">
              <h3 class="box-title">Direcciones y Coordinaciones Registradas </h3>
              <a href="{{ route('gestion.create') }}" class="btn btn-success pull-right">Crear Direccion/Coodrinacion</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tr>
                      ...
                      <td>
                       <!--  <a href="#" class="btn btn-xs btn-default"><i class="fa fa-eye"></i></a> -->
                          <a href="{{route ('gestion.edit',$gestion->id)}}" class="btn btn-xs btn-info"><i class="fa fa-pencil"></i></a>
                          <form method='POST' 
                                action="{{route('gestion.destroy',$gestion['id'])}}"
